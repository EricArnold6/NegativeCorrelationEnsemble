...
def write_csv(clean_acc, acc, args, i, j):
    ...
    if args.train_type == 'single' and args.loss_type == 'ce':
        col = 2 + j
    elif args.train_type == 'single' and args.loss_type == 'regular_loss':
        col = 31 + j
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'ce':
        col = 7
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_loss' and args.dynamic_type == 'normal':
        col = 8
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_dis_loss' and args.dynamic_type == 'normal':
        col = 9
    # elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss' and args.dynamic_type == 'normal':
    #     col = 10
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_dis_regular_loss' and args.dynamic_type == 'normal':
        col = 11
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'regular_loss' and args.dynamic_type == 'normal':
        col = 12
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'dis_regular_loss' and args.dynamic_type == 'normal':
        col = 13
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'weight_regular_loss' and args.dynamic_type == 'normal':
        col = 14
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss_new' and args.dynamic_type == 'normal':
        col = 17
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss_new3' and args.dynamic_type == 'normal':
        col = 18
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss_new4' and args.dynamic_type == 'normal':
        col = 19
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss_new0' and args.dynamic_type == 'normal':
        col = 20
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss_new5' and args.dynamic_type == 'normal':
        col = 21
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss_new6' and args.dynamic_type == 'normal':
        col = 22
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss_new7' and args.dynamic_type == 'normal':
        col = 23
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss' and args.dynamic_type == 'normal' \
            and args.para_flag == True \
            and args.alpha == 0.01:
        col = 24
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss_new15' and args.dynamic_type == 'normal':
        col = 25
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss_new_iter' and args.dynamic_type == 'normal':
        col = 26
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss' and args.dynamic_type == 'normal' \
            and args.para_flag == True \
            and args.alpha == 0.018:
        col = 27
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss' and args.dynamic_type == 'normal' \
            and args.para_flag == True \
            and args.alpha == 0.005:
        col = 28
    elif args.train_type == 'loss_ensemble' and args.loss_type == 'gal_regular_loss' and args.dynamic_type == 'normal' \
            and args.para_flag == True \
            and args.alpha == 0.015:
        col = 29
    else:
        return
