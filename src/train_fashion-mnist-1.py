...
parser.add_argument('--n_epochs', default=40, type=int, metavar='N',
                    help='')
parser.add_argument('--path_suffix', default='resnet26', type=str,
...
parser.add_argument('--loss_type', default='project_loss', type=str,
...
parser.add_argument('--para_norm', default=7, type=int,
                    help='para before norm_loss')
parser.add_argument('--para_cos', default=0.1, type=int,
